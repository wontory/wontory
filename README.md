...
![wontory/tech-stack@orbit](https://tech-stack.wontory.dev/api/orbit?text=wontory&slugs=react,typescript,tailwindcss,framer)

![TypeScript](https://tech-stack.wontory.dev/api/badge?slug=typescript&text=TypeScript&highlight=true&textColor=000000&bgColor=d1e7ff)
![React](https://tech-stack.wontory.dev/api/badge?slug=react&text=React&highlight=true&textColor=ffffff&bgColor=0056b8)
...
![TanStack Query](https://tech-stack.wontory.dev/api/badge?slug=reactquery&text=TanStack+Query&highlight=true&textColor=ffffff&bgColor=8a0000)
